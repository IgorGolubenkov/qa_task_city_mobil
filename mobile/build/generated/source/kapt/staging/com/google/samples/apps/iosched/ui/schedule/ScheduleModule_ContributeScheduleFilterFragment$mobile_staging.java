...
@Module(
  subcomponents =
      ScheduleModule_ContributeScheduleFilterFragment$mobile_staging
          .ScheduleFilterFragmentSubcomponent.class
)
public abstract class ScheduleModule_ContributeScheduleFilterFragment$mobile_staging {
  private ScheduleModule_ContributeScheduleFilterFragment$mobile_staging() {}
