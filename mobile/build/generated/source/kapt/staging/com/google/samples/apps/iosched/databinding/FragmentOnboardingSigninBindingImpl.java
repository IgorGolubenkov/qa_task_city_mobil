...
public class FragmentOnboardingSigninBindingImpl extends FragmentOnboardingSigninBinding implements com.google.samples.apps.iosched.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.onboarding_schedule, 4);
        sViewsWithIds.put(R.id.onboarding_signin_message, 5);
        sViewsWithIds.put(R.id.spacer, 6);
    }
    // views
    @NonNull
    ...
    public FragmentOnboardingSigninBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentOnboardingSigninBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback8 = new com.google.samples.apps.iosched.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.buttonSignin.setOnClickListener(mCallback8);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
