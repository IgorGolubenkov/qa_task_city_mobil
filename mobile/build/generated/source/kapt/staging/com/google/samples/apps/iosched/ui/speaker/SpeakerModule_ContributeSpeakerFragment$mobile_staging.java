...
@Module(
  subcomponents =
      SpeakerModule_ContributeSpeakerFragment$mobile_staging.SpeakerFragmentSubcomponent.class
)
public abstract class SpeakerModule_ContributeSpeakerFragment$mobile_staging {
  private SpeakerModule_ContributeSpeakerFragment$mobile_staging() {}
