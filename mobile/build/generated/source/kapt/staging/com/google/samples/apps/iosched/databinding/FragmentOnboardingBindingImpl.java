...
public class FragmentOnboardingBindingImpl extends FragmentOnboardingBinding implements com.google.samples.apps.iosched.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.guide_actions, 4);
    }
    // views
    @NonNull
    ...
    private FragmentOnboardingBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.pixelcan.inkpageindicator.InkPageIndicator) bindings[3]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.google.samples.apps.iosched.ui.onboarding.OnboardingViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.google.samples.apps.iosched.ui.onboarding.OnboardingViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.google.samples.apps.iosched.ui.onboarding.OnboardingViewModel viewModel = mViewModel;
        // batch finished
