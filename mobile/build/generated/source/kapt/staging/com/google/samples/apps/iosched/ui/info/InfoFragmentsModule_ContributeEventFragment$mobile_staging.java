...
@Module(
  subcomponents =
      InfoFragmentsModule_ContributeEventFragment$mobile_staging.EventFragmentSubcomponent.class
)
public abstract class InfoFragmentsModule_ContributeEventFragment$mobile_staging {
  private InfoFragmentsModule_ContributeEventFragment$mobile_staging() {}
