...
public class FragmentInfoBindingImpl extends FragmentInfoBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.snackbar, 5);
    }
    // views
    // variables
    // values
    ...
    private FragmentInfoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.google.samples.apps.iosched.widget.FadingSnackbar) bindings[5]
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1L) != 0) {
            ...
            com.google.samples.apps.iosched.util.ViewBindingAdaptersKt.pageMargin(this.viewpager, viewpager.getResources().getDimension(R.dimen.info_page_margin));
