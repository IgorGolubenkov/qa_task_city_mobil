...
public class FragmentOnboardingWelcomePreBindingImpl extends FragmentOnboardingWelcomePreBinding implements com.google.samples.apps.iosched.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.io_date_2019, 4);
        sViewsWithIds.put(R.id.welcome_pre_message, 5);
    ...
    public FragmentOnboardingWelcomePreBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentOnboardingWelcomePreBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.buttonSignin.setOnClickListener(mCallback23);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
